...
# 
# Run as:
#  .\rebuild-linux.ps1 "..\cw-artifacts"
# 
# Or:
#  .\rebuild-linux.ps1 "..\cw-artifacts" 00420
# 
# Or:
#  .\rebuild-linux.ps1 "..\cw-artifacts" -configuration Debug
# 
# Or:
#  .\rebuild-linux.ps1 "..\cw-artifacts" -mono /usr/local/bin/mono
...
$fx_excluded = @("CopperWire.WebSocket.WebSocket4NetCore")
$fc_excluded = "CopperWire.WebSocket.WebSocket4Net","CopperWire.WebSocket.WebSocketSharp"
$al_excluded = @("CopperWire.Test")
...
function Build-Project([string] $project, [string] $framework, [string] $configuration, [string] $mono, [string] $version_suffix)
{
    ...
    elseif ($framework.StartsWith("netstandard"))
    {
        ...
        if ($framework -eq "netstandard1.1" -and $project.StartsWith("CopperWire.WebSocket"))
        {
            Write-Host "Skipping building $project for framework $framework"
            Return 0
        }
...
# find projects
$projects = Get-ChildItem | ? { $_.Name.StartsWith("CopperWire") -and ($_.Attributes -band [System.IO.FileAttributes]::Directory) -eq [System.IO.FileAttributes]::Directory } | Sort-Object
